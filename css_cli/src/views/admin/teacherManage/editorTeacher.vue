...
export default {
  ...
  created() {
    ...
    axios.get('http://localhost:9090/teacher/findTeaById/' + this.ruleForm.tid).then(function (resp) {
    ...
    submitForm(formName) {
      this.$refs[formName].validate((valid) => {
        if (valid) {
          ...
          axios.post("http://localhost:9090/teacher/updateTea", this.ruleForm).then(function (resp) {
